      ...
      },
      {
        ...
        validate: (employeeIDInput) => {
          if (this.validateNumberValue(employeeIDInput)) {
            ...
            console.log(
              "Please enter a valid employee ID! (Only numbers are allowed)"
            );
            return false;
          }
        },
    ...
    return [
      {
        ...
        validate: (officeNumberInput) => {
          if (
            officeNumberInput === "" ||
            this.validateNumberValue(officeNumberInput)
          ) {
            return true;
          } else {
            process.stdout.clearLine();
            process.stdout.cursorTo(0);
            console.log(
              "Please enter a valid office number! (Only numbers are allowed)"
            );
            return false;
          }
        },
